...
A utility function to create a vector from a list of coordinates. This is a shorthand for `[x, y, z, ...]`. It also tags the array with a non-enumerable `__isVector__` property for efficient type checking.
