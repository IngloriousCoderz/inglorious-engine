export const data = [
  ...
  },
  {
    ...
    date: "2023-08-28",
    body: "The store worked pretty well, but then I lost interest. A year later, I started reading a book on game AI algorithms. This reignited my motivation because I wanted to experiment with developing those algorithms using FP instead of OOP.",
  },
  {
  ...
  },
  {
    ...
    title: "Coding Spree",
    date: "2025-10-05",
    body: "I couldn't stop coding. LLMs gave me the validation and the low-level coding capabilities to write a really cool game engine. I added a scaffolding tool, sound and touch support, an entity pool for performance... heck, I even created my own JavaScript superset for vector operations! But then I realized something...",
  },
  {
