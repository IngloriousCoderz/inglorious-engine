...
The `spriteAnimationSystem` is a good example of a **System** in Inglorious Engine. You can learn more about **Systems and how they compare to entity behaviors**.
