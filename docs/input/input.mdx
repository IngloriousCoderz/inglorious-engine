...
The `controlsTypes()` and `controlsEntities()` functions allow you to define input mappings that work for both keyboards and gamepads simultaneously, abstracting away the device-specific details. This makes your game's control logic cleaner and more flexible.
