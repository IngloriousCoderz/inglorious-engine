...
You configure your game by passing a configuration object to the `Engine`. This object defines everything about your game: entities, types, systems, and global settings.
...
The game is an entity like any other in the game, that we can customize as we please.
