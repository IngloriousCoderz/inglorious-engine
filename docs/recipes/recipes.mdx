...
This recipe shows how to implement a power-up system like in Super Mario. It's a practical example of the engine's **[Composition over Inheritance](/docs/engine-core-concepts-composition--docs)** philosophy, where we dynamically change the character's type definition at runtime.
