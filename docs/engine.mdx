...
Instead of relying on complex class inheritance hierarchies, we use **function composition**. In this example, all the code necessary to render the character is encapsulated in a `character()` behavior.
