...
import { coefficients, distanceFromPoint, intersectsCircle } from './segment.js'
...
test('it should compute the distance between a segment and a point resting on it', () => {
  ...
  expect(distanceFromPoint(segment, point)).toBeCloseTo(expectedResult, 0.01)
})
...
test('it should compute the distance between a segment and a point close to the end', () => {
  ...
  expect(distanceFromPoint(segment, point)).toBeCloseTo(expectedResult, 0.1)
})
